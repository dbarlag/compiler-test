    ...
    <div data-figma-id="316:21605" data-figma-name="redcross.no/home" className={styles.redcrossnohome40}>
      ...
      <section data-figma-id="646:22899" data-figma-name="Hero" className={styles.Hero7}>
        ...
        <section data-figma-id="657:22053" data-figma-name="Girl section" className={styles.GirlSection6}>
          <img data-figma-id="646:22322" data-figma-name="Redcross-graphics-1" src="https://figma-alpha-api.s3.us-west-2.amazonaws.com/images/7e5e0102-6a28-493a-9ae1-6d3bbda8c8ee" alt="Redcross-graphics-1" className={styles.Redcrossgraphics13} />
          <img data-figma-id="647:22901" data-figma-name="girl" src="https://figma-alpha-api.s3.us-west-2.amazonaws.com/images/ff758718-ca1d-45fc-ac72-0d7ae27998ca" alt="girl" className={styles.girl4} />
          <img data-figma-id="646:22327" data-figma-name="Redcross-graphics-1" src="https://figma-alpha-api.s3.us-west-2.amazonaws.com/images/f2ca7e45-12db-4ce1-a55c-fc288df888ce" alt="Redcross-graphics-1" className={styles.Redcrossgraphics15} />
        </section>
      </section>
      <section data-figma-id="316:21652" data-figma-name="Section2: Call to action" className={styles.Section2CallToAction12}>
        ...
        <div data-figma-id="316:21655" data-figma-name="Buttons" className={styles.Buttons11}>
          <div className={styles.dsWrapper10}>
            <Button loading={false} showIconRight={false} showIconLeft={false} variant="secondary" data-color="primary" data-figma-id="316:21657" data-figma-name="Button">Secondary</Button>
          </div>
          <div className={styles.dsWrapper10}>
            <Button loading={false} showIconRight={false} showIconLeft={false} variant="primary" data-color="primary" data-figma-id="316:21656" data-figma-name="Button" onClick={showHelloWorld}>Call to action</Button>
          </div>
        </div>
      </section>
        ...
        <article data-figma-id="316:21664" data-figma-name="Feature cards 1" className={styles.FeatureCards121}>
          {repeatItems1.map((item, index) => (
            <div key={index} className={styles.dsWrapper20}>
              <Card variant={false} data-color="neutral" className={styles.dsStyle19} data-figma-id="316:21665" data-figma-name="Card">
      ...
      <section data-figma-id="316:21672" data-figma-name="Section4: stats" className={styles.Section4Stats33}>
        ...
        <div data-figma-id="316:21708" data-figma-name="texts" className={styles.texts32}>
          ...
          <img data-figma-id="316:21724" data-figma-name="Line 1" src="https://figma-alpha-api.s3.us-west-2.amazonaws.com/images/d9e2bed7-b223-47ee-b293-034e5978f935" alt="Line" className={styles.Line130} />
          ...
          <img data-figma-id="316:21740" data-figma-name="Line 2" src="https://figma-alpha-api.s3.us-west-2.amazonaws.com/images/3b423511-dd06-4b92-b63a-b2b58059af14" alt="Line" className={styles.Line130} />
      ...
      <section data-figma-id="316:21756" data-figma-name="Section5: text-photo" className={styles.Section5Textphoto39}>
        <div data-figma-id="316:21757" data-figma-name="Row 1" className={styles.Row136}>
          <div data-figma-id="316:21758" data-figma-name="Content" className={styles.Content35}>
            ...
            <div className={styles.dsWrapper10}>
              <Button loading={false} showIconRight={false} showIconLeft={false} variant="primary" data-color="primary" data-figma-id="316:21762" data-figma-name="Button" onClick={showHelloWorld}>A button</Button>
            </div>
          </div>
        </div>
